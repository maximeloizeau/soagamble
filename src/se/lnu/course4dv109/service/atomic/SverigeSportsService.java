...
public class SverigeSportsService extends AtomicService {

	private List<SportEvent> events = new ArrayList<SportEvent>();
	
	public SverigeSportsService(String serviceName, String serviceEndpoint) {
		super(serviceName, serviceEndpoint);
	}

	@ServiceOperation
	public SportEvent requestResult(int matchId) throws Exception {
		System.out.println("[4DV109] SverigeSportsService.requestResult");
	...
	public List<SportEvent> requestSportEvents() {
		System.out.println("[4DV109] SverigeSportsService.requestSportEvents");
	...
	public static void main(String[] args) {
		SverigeSportsService sportsEventsService = new SverigeSportsService("SportsEventsService", "se.lnu.course4dv109.service.sverigesportsevents");
		
		Map<String, Object> customProperties = sportsEventsService.getServiceDescription().getCustomProperties();
		customProperties.put("Cost", 1);
		customProperties.put("Complexity", 3);
		customProperties.put("ResponseTime", 1);
